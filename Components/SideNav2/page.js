        ...
        <div className="side-nav">
          <div className="side-nav-container">
            ...
            {/* <Link href="/" className="mb-2 flex h-20 items-end justify-start rounded-md bg-blue-600 p-4 md:h-40">
                 ...
                 <Link href="/satelitteDashboard/" className="nav-link">Home</Link>
                <Link href="/satelitteDashboard/add" className="nav-link">Add Blood</Link>
                 <Link href="/satelitteDashboard/update" className="nav-link">Transfer Blood</Link>
